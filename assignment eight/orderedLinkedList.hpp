/*
Title: Chapter Sixteen Linked List Print Backwards Program -- orderedLinkedList Header File
...
public:
    ...
    //Function to insert newItem in the list.
        ...
        //at the proper place in thelist, and count is incremented by 1.
    void insert(const Type& newItem);
    
    //Function to insert newItem in the list. Because the resulting list 
    //must be sorted, newItem is inserted at the proper in the list.
    //This function uses the function insert to insert newItem.
        //Postcondition: first points to the new list, newItem is
        //inserted at the proper in the list, and count is incremented by 1.
    ...
    //Function to delete deleteItem from the list.
        ...
        //first points to the first node of the new list, and count is decremented by 1.
...
void orderedLinkedList<Type>::insert(const Type& newItem)
{
    ...
    //Function to insert newItem into list first
template<class Type>
void orderedLinkedList<Type>::insertFirst(const Type& newItem)
{
    ...
    //Function to insert newItem into list last
template<class Type>
